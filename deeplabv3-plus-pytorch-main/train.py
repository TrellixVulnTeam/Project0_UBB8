...
from utils.dataloader import DeeplabDataset, deeplab_dataset_collate, split_train_val
...
if __name__ == "__main__":
    ...
    #  ----------------------------------------------------------------------------------------------------------------
    model_path =''
        # 'logs/PREEXep099-loss0.820-val_loss1.288.pth'
    #  -------------------------------#
    #   下采样的倍数8、16 
    #   8要求更大的显存
    #  -------------------------------#
    ...
    if model_path != '':
        ...
        #   权值文件请看README，百度网盘下载
        #  ------------------------------------------------------#
        print('Load weights %s.' % model_path)
    ...
    if True:
        ...
        train_dataset = DeeplabDataset(image_paths, label_paths, mode='train')
        # val_dataset = DeeplabDataset(val_lines, input_shape, num_classes, False, VOCdevkit_path)
        val_dataset = DeeplabDataset(val_image_paths,val_label_paths,mode = 'val')
