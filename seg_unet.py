...
# import segmentation_models_pytorpich as smp
# import torch
#
# def unet(pretrained_weights=None, input_size=(512, 512, 3), classNum=6, learning_rate=1e-5):
...
#     except:
#         merge6 = concatenate([drop3, up6], mode='concat', concat_axis=3)
#     conv6 = BatchNormalization()(Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge6))
#     conv6 = BatchNormalization()(Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv6))
#
#     up7 = Conv2D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(conv6))
#     try:
#         merge7 = concatenate([conv2, up7], axis=3)
#     except:
#         merge7 = concatenate([conv2, up7], mode='concat', concat_axis=3)
#     conv7 = BatchNormalization()(Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge7))
#     conv7 = BatchNormalization()(Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv7))
#
#     up8 = Conv2D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(conv7))
#     try:
#         merge8 = concatenate([conv1, up8], axis=3)
#     except:
#         merge8 = concatenate([conv1, up8], mode='concat', concat_axis=3)
#     conv8 = BatchNormalization()(Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge8))
#     conv8 = BatchNormalization()(Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv8))
#
...
#     conv10 = Conv2D(classNum, 1, activation='softmax')(conv8)
#
...
from tensorflow.keras.models import Model
from tensorflow.keras.layers import Input, BatchNormalization, Conv2D, MaxPooling2D, Dropout, UpSampling2D
from tensorflow.keras.optimizers import Adam
from tensorflow.keras.layers import concatenate
