...
class BilinearUpsampling(Layer):
    ...
    def call(self, inputs):
        if self.upsampling:
            return K.tf.compat.v1.image.resize_bilinear(inputs, (inputs.shape[1] * self.upsampling[0],
                                                        inputs.shape[2] * self.upsampling[1]),
                                                        align_corners=True, name = self.name )

        else:
            return K.tf.compat.v1.image.resize_bilinear(inputs, (self.upsample_size[0],
...
def Deeplabv3pa(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=21, OS=16):
    ...
    x0 = Reshape((32, 32, 1, 256))(x0)
    x1 = Reshape((32, 32, 1, 256))(x1)
    x2 = Reshape((32, 32, 1, 256))(x2)
    x3 = Reshape((32, 32, 1, 256))(x3)
    x4 = Reshape((32, 32, 1, 256))(x4)
...
#     Deeplabv3pa(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=21, OS=16)
