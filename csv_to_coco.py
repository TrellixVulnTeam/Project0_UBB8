...
if __name__ == '__main__':
    csv_file = r"D:\data\kaggle-airbus-ship-detection\train_ship_segmentations_v2.csv"
    image_dir = r"D:\data\kaggle-airbus-ship-detection\train_v2"
    saved_coco_path = r"D:\data\kaggle-airbus-ship-detection"
    # 整合csv格式标注文件
