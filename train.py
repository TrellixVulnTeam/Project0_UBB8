...
import os
# DEVICE = 'CUDA:0'
# os.environ['CUDA_VISIBLE_DEVICES'] = '/device:GPU'
...
#  训练数据图像路径
train_image_path = r"E:\data\YAMATO\train"
#  训练数据标签路径
train_label_path = r"E:\data\YAMATO\label"
#  验证数据图像路径
validation_image_path = r"E:\data\YAMATO\valimage"
#  验证数据标签路径
validation_label_path = r"E:\data\YAMATO\vallabel"
...
model_path = "Model\\unet_model3.hdf5"
#  训练数据数目
