...
import OCR,OAR
import OAR2,OAR3
from PFSeg import AlignNetResNetMaxAvgpool
...
class VAN(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=6, embed_dims=[64, 128, 256, 512],
        ...
        self.pfseg = AlignNetResNetMaxAvgpool(num_classes=6)
        ...
        # self.conv3 = nn.Conv2d(128, 18, kernel_size=1, stride=1, padding=0)
        #
