...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        num_classes = 6
        hidden_dim = 256
        # self.upch0 = nn.Conv2d(32, hidden_dim, kernel_size=1)
        # self.upch1 = nn.Conv2d(64, hidden_dim, kernel_size=1)
        # self.upch2 = nn.Conv2d(160, hidden_dim, kernel_size=1)
        # self.upch3 = nn.Conv2d(256, hidden_dim, kernel_size=1)
        # ocr_mid_channels = config.MODEL.OCR.MID_CHANNELS
        # ocr_key_channels = config.MODEL.OCR.KEY_CHANNELS
        # self.sub = nn.Conv2d(480, 256, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x):
        ...
        # out0 = self.cls_head(feats)
        # feats0 = ModuleHelper.BNReLU(num_features=128)(self.semantic_branch(feats0))


        # out0 = self._upsample(out0, 512, 512)
        out_aux0 = self._upsample(out_aux0, 512, 512)
        out_aux_seg.append(out_aux0)
        # out_aux_seg.append(out0)
        ...
        # feats1 = ModuleHelper.BNReLU(num_features=128)(self.semantic_branch(feats1))
        ...
        # feats2 = ModuleHelper.BNReLU(num_features=128)(self.semantic_branch(feats2))
        ...
        # feats3 = ModuleHelper.BNReLU(num_features=128)(self.semantic_branch(feats3))
        ...
        # out = feats3 + feats2 + feats1 + feats0
