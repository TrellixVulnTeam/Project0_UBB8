...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.stage2, pre_stage_channels = self._make_stage(
            {'NUM_MODULES': 1, 'NUM_BRANCHES': 2, 'NUM_BLOCKS': [4, 4], 'NUM_CHANNELS': [48, 96], 'BLOCK': 'BASIC',
             'FUSE_METHOD': 'SUM'}, num_channels)
        ...
        self.stage3, pre_stage_channels = self._make_stage(
            {'NUM_MODULES': 4, 'NUM_BRANCHES': 3, 'NUM_BLOCKS': [4, 4, 4], 'NUM_CHANNELS': [48, 96,192], 'BLOCK': 'BASIC',
             'FUSE_METHOD': 'SUM'}, num_channels)
        ...
        self.stage4, pre_stage_channels = self._make_stage(
            {'NUM_MODULES': 3, 'NUM_BRANCHES': 4, 'NUM_BLOCKS': [4, 4, 4, 4], 'NUM_CHANNELS': [48, 96, 192,384],
             'BLOCK': 'BASIC', 'FUSE_METHOD': 'SUM'}, num_channels, multi_scale_output=True)
    ...
    def forward(self, x):
        ...
        out_aux = self._upsample(out_aux, 512, 512)
